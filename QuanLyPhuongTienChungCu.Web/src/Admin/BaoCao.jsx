    ...
    <div className="bc-wrapper">
      <div className="bc-body">
        <div className="bc-title-bar">
          <h2>Báo cáo</h2>
          <button className="bc-btn-export" onClick={xuatBaoCao}>Xuất báo cáo</button>
        </div>
              ...
              <div className="bc-bar-area">
                ...
                <div className="bc-bar-list">
                  {doanhThuNgay.length === 0 ? (
                    <p style={{ width: "100%", textAlign: "center", color: "#6b8fa3", alignSelf: "center" }}>Chưa có dữ liệu</p>
                  ) : (
                    doanhThuNgay.map((d, i) => (
                      <div key={i} className="bc-bar-item">
                        <div className="bc-bar" style={{ height: `${((Number(d.giaTri) || 0) / maxGiaTri) * 100}%` }} title={`${d.giaTri}`} />
          ...
          <div className="bc-chart-card">
            ...
            <div className="bc-pie-wrapper">
              ...
              <div className="bc-pie-legend">
                <div className="bc-legend-item"><span className="bc-dot bc-dot-oto" /><span>Ô tô</span><strong>{tyLe.oto}%</strong></div>
                <div className="bc-legend-item"><span className="bc-dot bc-dot-xemay" /><span>Xe máy</span><strong>{tyLe.xemay}%</strong></div>
                <div className="bc-legend-item"><span className="bc-dot bc-dot-xedap" /><span>Xe đạp</span><strong>{tyLe.xedap}%</strong></div>
                <div className="bc-legend-item"><span className="bc-dot bc-dot-khac" /><span>Khác</span><strong>{tyLe.khac}%</strong></div>
              </div>
            </div>
          </div>
        </div>
