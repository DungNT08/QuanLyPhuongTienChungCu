...
const danhSachMenu = [
  ...
  { icon: "🚗", ten: "Phương tiện của tôi", duongDan: "/phuong-tien-cua-toi" },
  { icon: "◷", ten: "Lịch sử gửi xe", duongDan: "/lich-su-gui-xe" },
  { icon: "▥", ten: "Hóa đơn & thanh toán", duongDan: "/hoa-don" },
  { icon: "🔔", ten: "Thông báo", duongDan: "/thong-bao" },
  { icon: "👤", ten: "Hồ sơ cá nhân", duongDan: "/ho-so" },
];
  ...
  return (
    <>
      ...
      <header className="header-trang-chu">
        ...
        {/* ===== KHU VỰC USER ===== */}
        <div className="thong-tin-admin" ref={userRef} style={{ position: "relative" }}>
          ...
          {hienMenuUser && (
            ...
            >
              ...
              >
                <div style={{ fontSize: 14, fontWeight: 800, color: "#0f3b56" }}>
                  Nguyễn Văn A
                </div>
